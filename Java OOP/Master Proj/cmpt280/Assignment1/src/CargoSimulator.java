...
public class CargoSimulator {
    ...
    public static void main(String args[]) {
        ...
        sim.fleet.iterator().goFirst();
        //System.out.println(sim.toString());
        System.out.println("The "+sim.fleet.iterator().item().name+" is carrying "+sim.fleet.iterator().item().sacksOfGrainType(Grain.WHEAT)+" sacks of wheat");
